...
<div className="w-full sm:px-4 md:px-20 lg:px-48 xl:px-64">
    <div className={'bg-gray-500 h-48 font-medium border-gray-800 mx-auto px-6 sm:px-6 md:px-12 lg:px-24 flex flex col justify-between'}>
      <h5
...
<Accordion.Panel>
  <Accordion.Title className={'mx-auto flex flex col w-screen' } style={{color: '#858480', fontSize: '20px',
...
<Accordion.Panel>
  <Accordion.Title style={{color: '#858480', fontSize: '20px',
   justifyContent: 'center'}}>
    FireBlade Token!
  </Accordion.Title>
  <Accordion.Content>
