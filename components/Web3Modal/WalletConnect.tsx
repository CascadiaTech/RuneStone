...
export const ConnectWallet = () => {
  ...
  return (
    <div>
      {active ? (<button type="button" onClick={onActiveClick} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Disconnect Wallet</button>) : (
        <div>
           <button type="button" onClick={OnClick} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Connect Wallet</button>
  <Modal
    show={visible}
    size="md"
    popup={true}
  ...
  >
    ...
    <div className="p-6">
                ...
                <ul className="my-4 space-y-3">
                    <li className="sm:hidden md:visible lg:visible">
                        <a onClick={ () => ConnectInjected()} className="cursor-pointer flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                    ...
                    <li>
                        <a onClick={ () => ConnectCoinbase()} className="cursor-pointer flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                    ...
                    <li>
                        <a onClick={ () => ConnectWalletConnect()} className="cursor-pointer flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                ...
                <div>
                    <a href="https://www.dynamic.xyz/blog/connecting-vs-sign-in-with-your-wallet" className="inline-flex items-center text-xs font-normal text-gray-500 hover:underline dark:text-gray-400">
